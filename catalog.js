import{s as y,r as T,h as f}from"./assets/members-modal-D1kCSRWA.js";import"./assets/hero-C7dGqz6r.js";const m=document.querySelector(".movies__list-items"),u=document.querySelector(".pagination-container");let t=1,c=0,p="",I;const M=document.querySelector(".movies__search"),b=document.querySelector("#catalog-search-btn"),h=document.querySelector(".clear-search");b.addEventListener("click",()=>{const e=document.createElement("div");e.textContent="BOSU BOSUNA O TUSA BASMA ARTIK ZATEN INPUT YERINE YAZINCA ARIYOR!",e.style.cssText=`
        position: fixed;
        top: 20px;
        left: 50%;
    ...
    `,document.body.appendChild(e),setTimeout(()=>{e.style.opacity="1"},0)});M.addEventListener("input",e=>{p=e.target.value.trim(),p?h.classList.add("visible"):h.classList.remove("visible"),clearTimeout(I),I=setTimeout(()=>{t=1,d(t)},500)});h.addEventListener("click",()=>{M.value="",p="",h.classList.remove("visible"),t=1,d(t)});async function d(e=1){y();try{const n={method:"GET",headers:{accept:"application/json",Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0OGFlMTQ1ZTQyYzc4MDQ5YjI3Y2MwY2NhZWU1NGE3NSIsIm5iZiI6MTc0MzYzNzA0MC4yMzksInN1YiI6IjY3ZWRjYTMwMDM1NDBjZjhlNTYyODgwNCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.tuTxlFoUnsTSw7K5siU94XHqec4Jgt-IVZeRxvzIv2Y"}},o=p?`https://api.themoviedb.org/3/search/movie?query=${encodeURIComponent(p)}&language=en-US&page=${e}`:`https://api.themoviedb.org/3/trending/all/day?language=en-US&page=${e}`,r=await(await fetch(o,n)).json();if(c=r.total_pages,m.innerHTML="",r.results.length===0){m.innerHTML=`
      ...
      `,a.addEventListener("click",()=>{T(s)}),m.appendChild(a)}),N()}catch(n){console.error("Error fetching movies:",n),m.innerHTML='<li class="error-message">Filmler yüklenirken bir hata oluştu.</li>'}finally{f()}}function N(){u.innerHTML="";const e=document.createElement("div");e.className="pagination-wrapper";const n=document.createElement("button");n.innerHTML="<",n.className="pagination-button prev",n.disabled=t===1,n.addEventListener("click",()=>{t>1&&(t--,d(t))});const o=document.createElement("div");o.className="pagination-pages";let l=Math.max(1,t-1),r=Math.min(c,l+2);if(r===c&&(l=Math.max(1,r-2)),l>1){const a=v(1);if(o.appendChild(a),l>2){const i=document.createElement("span");i.textContent="...",i.className="pagination-ellipsis",o.appendChild(i)}}for(let a=l;a<=r;a++){const i=v(a);o.appendChild(i)}if(r<c){if(r<c-1){const i=document.createElement("span");i.textContent="...",i.className="pagination-ellipsis",o.appendChild(i)}const a=v(c);o.appendChild(a)}const s=document.createElement("button");s.innerHTML=">",s.className="pagination-button next",s.disabled=t===c,s.addEventListener("click",()=>{t<c&&(t++,d(t))}),e.appendChild(n),e.appendChild(o),e.appendChild(s),u.appendChild(e)}function v(e){const n=document.createElement("button");return n.textContent=e.toString().padStart(2,"0"),n.className="pagination-button page",e===t&&n.classList.add("active"),n.addEventListener("click",()=>{e!==t&&(t=e,d(t))}),n}document.addEventListener("DOMContentLoaded",()=>{if(!u){const e=document.createElement("div");e.className="pagination-container",document.querySelector(".movies__list").after(e)}d()});const E={method:"GET",headers:{accept:"application/json",Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0OGFlMTQ1ZTQyYzc4MDQ5YjI3Y2MwY2NhZWU1NGE3NSIsIm5iZiI6MTc0MzYzNzA0MC4yMzksInN1YiI6IjY3ZWRjYTMwMDM1NDBjZjhlNTYyODgwNCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.tuTxlFoUnsTSw7K5siU94XHqec4Jgt-IVZeRxvzIv2Y"}};fetch("https://api.themoviedb.org/3/trending/all/day?language=en-US",E).then(e=>e.json()).then(e=>console.log(e)).catch(e=>console.error(e));document.addEventListener("DOMContentLoaded",()=>{y(),window.addEventListener("load",()=>{setTimeout(()=>{f()},500)})});
